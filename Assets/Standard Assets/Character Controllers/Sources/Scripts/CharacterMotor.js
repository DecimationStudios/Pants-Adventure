...
static var setGravity : float = 0.0;
...
private function ApplyGravityAndJumping (velocity : Vector3) {
	...
	if (grounded)
		velocity.y = Mathf.Min(0, velocity.y) - movement.gravity * Time.deltaTime + setGravity * Time.deltaTime;
	else {
		velocity.y = movement.velocity.y - movement.gravity * Time.deltaTime + setGravity * Time.deltaTime;
